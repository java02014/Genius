 ...
 * Original file: E:\\Company_Project\\GeniusSample\\src\\com\\java02014\\genius\\command\\ICommandInterface.aidl
 */
package com.java02014.genius.command;
// Declare any non-default types here with import statements

public interface ICommandInterface extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.java02014.genius.command.ICommandInterface
{
private static final java.lang.String DESCRIPTOR = "com.java02014.genius.command.ICommandInterface";
...
/**
 * Cast an IBinder object into an com.java02014.genius.command.ICommandInterface interface,
 * generating a proxy if needed.
 */
public static com.java02014.genius.command.ICommandInterface asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.java02014.genius.command.ICommandInterface))) {
return ((com.java02014.genius.command.ICommandInterface)iin);
}
return new com.java02014.genius.command.ICommandInterface.Stub.Proxy(obj);
}
...
private static class Proxy implements com.java02014.genius.command.ICommandInterface
{
