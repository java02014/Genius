...
public class GeniusUI {
	...
	public static Typeface getFont(Context context, BaseAttributes attributes) {
		String fontPath = "fonts/" + attributes.getFontFamily() + "_"
				+ attributes.getFontWeight() + "."
		...
		try {
			...
			Log.e("GeniusUI",
					"Font file at "
							+ fontPath
							+ " cannot be found or the file is "
	 ...
	 */
	public static Drawable getActionBarDrawable(Activity activity, int theme,
			boolean dark) {
	 ...
	 */
	public static Drawable getActionBarDrawable(Activity activity, int theme,
			boolean dark, float borderBottom) {
