...
/**
 * Created by QiuJu on 2014/11/25.
 * <p/>
...
final public class BlurKit {
	 ...
	 * @return Image Bitmap
	 */
	public static Bitmap blurNatively(Bitmap original, int radius,
	 ...
	 * @return Image Bitmap
	 */
	public static Bitmap blurNativelyPixels(Bitmap original, int radius,
			boolean canReuseInBitmap) {
		if (radius < 1) {
			return null;
		}
