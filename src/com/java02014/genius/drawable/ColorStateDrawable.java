...
/**
 * A drawable that changes it's ColorStateList color depending on the Drawable
 * State
 * <p>
...
public abstract class ColorStateDrawable extends Drawable {
	 ...
	 * @param color
	 *            The {@link android.graphics.Color} the color object that
	 *            defines with the currentColor
	 *            {@link android.content.res.ColorStateList} color
	 * @param alpha
	 *            The the alpha is the modulateAlpha for paint
