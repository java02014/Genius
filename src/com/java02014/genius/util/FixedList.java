...
/**
 * Created by QiuJu on 2014/10/3. The queue of fixed storage size Queue length
 * is fixed The tail to add data beyond the specified size to delete header data
 * Head to add data beyond the specified size to delete the tail data Use a
 * method similar to LinkedList Queue operations can be performed, such as: add
 * elements, elements of poll
 */
public class FixedList<E> extends java.util.AbstractSequentialList<E> implements
		java.util.List<E>, java.util.Deque<E>, java.util.Queue<E>, Cloneable,
	...
	/**
	 * Returns a new {@code FixedLenList} with the same elements and size as
	 * this {@code FixedLenList}.
	 * 
	 ...
	 *             if this {@code FixedLenList} is empty.
	 */
	public E getFirst() {
		return getFirstImpl();
	}
	...
	/**
	 * Searches this {@code FixedLenList} for the specified object and returns
	 ...
	 * {@code FixedLenList} with the specified object.
	 * 
	 * @param location
	 ...
	 *             if the type of an element in this {@code FixedLenList} cannot
