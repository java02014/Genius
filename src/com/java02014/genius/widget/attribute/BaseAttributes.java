 ...
 */
package com.java02014.genius.widget.attribute;
...
public class BaseAttributes extends Attributes {
	public static final String[] DEFAULT_FONT_FAMILY = new String[] { "roboto",
			"opensans" };
	public static final String[] DEFAULT_FONT_WEIGHT = new String[] { "bold",
			"extrabold", "extralight", "light", "regular" };
	...
	public BaseAttributes(AttributeChangeListener attributeChangeListener,
			Resources resources) {
	...
	public void initHasOwnAttrs(Context context, AttributeSet attrs) {
		...
		String textColorAttribute = attrs.getAttributeValue(
				GeniusUI.androidStyleNameSpace, "textColor");
		...
		String backgroundAttribute = attrs.getAttributeValue(
				GeniusUI.androidStyleNameSpace, "background");
		hasOwnBackground = backgroundAttribute != null;

		// getting android default tags for textColorHint
		hasHintTextColor = attrs.getAttributeValue(
				GeniusUI.androidStyleNameSpace, "textColorHint") != null;
	}

	public void initCornerRadius(TypedArray a, int indexRadius,
			int indexRadiiA, int indexRadiiB, int indexRadiiC, int indexRadiiD) {
		// Set Radius
